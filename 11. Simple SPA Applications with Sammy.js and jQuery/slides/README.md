...
<!-- attr: {class:'slide-section', id: 'www' } -->
# WWW
## What is WWW?
...
<!-- attr: {class: 'slide-section', id: 'url'} -->
# URL
## What is URL?
...
<!-- attr: {class: 'slide-section', id: 'html-xml-rss-json'} -->
# HTML, XML, JSON, RSS
...
<!-- attr: {id: 'xml', style: 'font-size: 0.98em', hasScriptWrapper: true } -->
# XML
...
<library>
  <book>
      <title>HTML 5</title><author>Bay Ivan</author>
  </book>
  <book>
    <title>WPF 4</title><author>Microsoft</author>
  </book>
  <book>
    <title>WCF 4</title><author>Kaka Mara</author>
  </book>
</library>
```
<img src="imgs/xml.png" style="position:absolute; top:8%; right:0%; width:20%; border:none; background:none; box-shadow:none" />

<!-- attr: {style: '0.98em', id: 'rss'} -->
# RSS
...
```
<!-- attr: {id: 'json', hasScriptWrapper: true} -->
# JSON
...
<!-- attr: {class: 'slide-section', id: 'http-protocol'} -->
# The HTTP Protocol
## How HTTP Works?
...
The empty line denotes the end of the request header <!-- .element; class="fragment" style="top:30%; right:25%; width:30%" -->
...
```
The empty line denotes the end of the response header  <!-- .element; class="fragment" style="top:65%; right:25%; width:30%" -->
...
<!-- attr: {style: 'font-size: 0.97em', hasScriptWrapper: true} -->
...
<!-- attr: {class: 'slide-section', id: 'restfull-web-services'} -->
...
<!-- attr: {class: 'slide-section', id: 'ajax'} -->
# AJAX
...
<!-- attr: {class: 'slide-section', id: 'same-origin-policy'} -->
...
<!-- attr: {class: 'slide-section', id: 'jsonp'} -->
# JSONP
...
<!-- attr: {class: 'slide-section', id: 'web-developer-tools'} -->
# Web Developer Tools
